...
- MATH HONESTY: If the selected products cannot physically deliver the target carbs for the ride duration, say so. Do not assign impossible carb totals to a single product. Example: one 500ml bottle of Formula 369 at 3 scoops = 90g carbs maximum — it cannot deliver 255g. If there is a gap between what's selected and what's needed, flag it clearly in resilience.warning: "One bottle of Formula 369 provides ~90g carbs — you need 255g total. Add a second bottle, gels, or a refill stop to hit your target." Never inflate a product's carb contribution beyond what it can physically hold.
