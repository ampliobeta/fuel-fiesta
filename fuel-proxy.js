...
- MATH HONESTY BOTH WAYS: If the plan total carbs significantly exceed the target (more than 15% over), flag it. Too much food means unnecessary weight and potential GI distress. Adjust quantities down to match the target rather than packing everything selected. The packing list should reflect what the rider actually needs, not the maximum of everything they own.
